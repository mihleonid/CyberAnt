#pragma once
enum FOType{FONone=0, FOBuilding=1, FOResourced=2, FOPutable=4, FOStorage=8, FOTubed=16, FOAresource=42, FOEnemy=64, FOBase=128};//флаги, что можно с ним делать
...
enum FOWhat{BBase, BIMine, BOMine, BBigTube, BGun, BRadio, RIron, ROxygen, RCristall};//radio = vishka
